...
//    }
     ...
     * Create the dialog
     */
    public QCompreDialog(String title, String kemu, String Qno, Connection c) {
        super();
        con=new Dao(c);
        setModal(true);
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (Qno.equals("")){
                    ...
                    String sql = "INSERT INTO Comprehensive VALUES('" + '5' + text_Qno1.getText() + "','" + text_question.getText() + "','";
