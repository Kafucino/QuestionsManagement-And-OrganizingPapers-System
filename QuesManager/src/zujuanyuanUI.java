...
import java.net.URL;
public class zujuanyuanUI extends JFrame implements ActionListener,ListSelectionListener,CaretListener{
...
//        table_show.getSelectionModel().addListSelectionListener(this);
    ...
    public static void main(String[] args) {
        try{
            zujuanyuanUI frame = new zujuanyuanUI();
